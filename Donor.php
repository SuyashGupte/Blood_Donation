	...
	<body>
		...
		<!--==============
			...
			<div  class="row">
				...
				<div id = "EligibilityTest" class="card">
					<a class = "CardLink"  data-toggle="modal" data-target="#EligibilityTestModal" href = "#">
						...
						<div class="container">
							...
							<p>Giving the "right" type of blood donation - based on your blood type and patient needs. Here are some things to consider when determining how you can have the most impact.</p> 
						</div>
					</a>
				</div>
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<DIV class="card">
					<A class = "CardLink" href = "Donor.php">
						...
						<DIV class="container">
							...
							<h4 align="center" ><b><br> GENERATE REPORT</b></h4> 
